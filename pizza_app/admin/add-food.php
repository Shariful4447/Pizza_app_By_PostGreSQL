        ...
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <table class="tbl-30">
                ...
                <tr>
                    <td>Title: </td>
                    <td>
                        <input type="text" name="title" placeholder="Title of the Pizza">
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="2">
                        <input style="padding: 10px; background: lightgreen; margin-top: 20px;" type="submit" name="submit" value="Add Pizza" >
                    </td>
                </tr>
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        $image_name = "product-".rand(0000,9999).".".$ext; //New Image Name May Be "Food-Name-657.jpg"
                ...
                if($res2 == true)
                {
                    ...
                    $_SESSION['add'] = "<div class='success'>Pizza Added Successfully.</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                }
                else
                {
                    //FAiled to Insert Data
                    $_SESSION['add'] = "<div class='error'>Failed to Add Pizza.</div>";
                    header('location:'.SITEURL.'admin/manage-food.php');
                }
