...
<div class="main-content" style="width: 95%; margin-left: 3%;">
    <div class="wrapper">
        ...
        <a style="float: right;" href="my-custom-orders.php">
              <button style="background-color: lightgreen; padding: 10px; border: unset;" type="button"><b>My Custom Pizza Orders</b></button>
        </a>
      ...
      <table id="customers">
            ...
            <tbody>
              <?php
                  ...
                  $sql = "SELECT * FROM tbl_order WHERE customer_email='$user_email' ORDER BY id DESC"; // DIsplay the Latest Order at First
